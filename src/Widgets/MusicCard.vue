...
<template>
  <BCard no-body no-header class="music-card position-relative" v-skeleton="false">
    <div class="cover" v-skeleton-item>
      <img src="/ysg1.jpg" alt="UnderGround" />
    </div>
